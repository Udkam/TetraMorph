...
const ENDGAME_LIBRARY: readonly EndgameDefinition[] = Object.freeze([
  ...
  // 31–39: six rows — combine wells, bridges, recovery lanes, and sparse headroom gates.
  ...
  endgame('tm-endgame-35', '悬台', 34, 374761393, setup(1732050832, [{ type: 'I', rotation: 2, x: 5 }, { type: 'S', rotation: 0, x: 2 }, { type: 'L', rotation: 1, x: -1 }, { type: 'T', rotation: 2, x: 1 }, { type: 'O', rotation: 3, x: 5 }, { type: 'J', rotation: 2, x: 7 }, { type: 'Z', rotation: 2, x: 7 }, { type: 'S', rotation: 0, x: 4 }, { type: 'J', rotation: 2, x: 7 }, { type: 'L', rotation: 0, x: 1 }, { type: 'T', rotation: 2, x: 0 }, { type: 'I', rotation: 0, x: 3 }])),
  endgame('tm-endgame-36', '斜阶', 35, 197830471, setup(142658, [{ type: 'T', rotation: 0, x: 1 }, { type: 'S', rotation: 1, x: 1 }, { type: 'Z', rotation: 1, x: -1 }, { type: 'I', rotation: 1, x: -2 }, { type: 'L', rotation: 1, x: 3 }, { type: 'J', rotation: 3, x: 6 }, { type: 'O', rotation: 0, x: 5 }, { type: 'T', rotation: 1, x: 0 }, { type: 'J', rotation: 0, x: 3 }])),
  endgame('tm-endgame-37', '双廊', 36, 668265263, setup(1732050830, [{ type: 'S', rotation: 3, x: 7 }, { type: 'T', rotation: 0, x: 0 }, { type: 'O', rotation: 3, x: 5 }, { type: 'L', rotation: 3, x: 8 }, { type: 'J', rotation: 2, x: 2 }, { type: 'I', rotation: 0, x: 0 }, { type: 'Z', rotation: 0, x: 0 }, { type: 'T', rotation: 2, x: 3 }, { type: 'J', rotation: 0, x: 6 }, { type: 'S', rotation: 2, x: 2 }, { type: 'L', rotation: 0, x: 7 }, { type: 'I', rotation: 2, x: 5 }])),
  endgame('tm-endgame-38', '层塔', 37, 1431374977, setup(156544, [{ type: 'I', rotation: 0, x: 1 }, { type: 'J', rotation: 0, x: 1 }, { type: 'Z', rotation: 0, x: 4 }, { type: 'T', rotation: 0, x: 2 }, { type: 'O', rotation: 0, x: 7 }, { type: 'L', rotation: 2, x: 6 }, { type: 'S', rotation: 1, x: 3 }, { type: 'Z', rotation: 1, x: 1 }, { type: 'O', rotation: 0, x: 6 }, { type: 'T', rotation: 2, x: 4 }])),
  endgame('tm-endgame-39', '边塔', 38, 41326521, setup(3236068023, [{ type: 'J', rotation: 0, x: 0 }, { type: 'O', rotation: 3, x: 8 }, { type: 'L', rotation: 0, x: 5 }, { type: 'T', rotation: 2, x: 0 }, { type: 'S', rotation: 1, x: 2 }, { type: 'Z', rotation: 1, x: 4 }, { type: 'I', rotation: 2, x: 2 }, { type: 'J', rotation: 2, x: 7 }, { type: 'O', rotation: 2, x: 8 }]), [{ x: 9, y: 13 }]),

  // 41, 44–50: seven-row recovery space and a ten-row trick board with multiple routes.
  endgame('tm-endgame-41', '横沟', 39, 2007309471, setup(4101007, [{ type: 'O', rotation: 2, x: 1 }, { type: 'I', rotation: 0, x: 4 }, { type: 'J', rotation: 1, x: -1 }, { type: 'Z', rotation: 3, x: 8 }, { type: 'L', rotation: 0, x: 3 }, { type: 'T', rotation: 2, x: 6 }, { type: 'S', rotation: 2, x: 3 }, { type: 'T', rotation: 2, x: 2 }, { type: 'O', rotation: 2, x: 0 }, { type: 'S', rotation: 2, x: 7 }, { type: 'Z', rotation: 0, x: 4 }, { type: 'I', rotation: 2, x: 6 }, { type: 'J', rotation: 2, x: 0 }, { type: 'L', rotation: 2, x: 3 }])),
  endgame('tm-endgame-44', '双塔', 40, 2076461737, setup(4101018, [{ type: 'S', rotation: 0, x: 2 }, { type: 'O', rotation: 2, x: 0 }, { type: 'I', rotation: 2, x: 0 }, { type: 'J', rotation: 3, x: 8 }, { type: 'L', rotation: 3, x: 4 }, { type: 'T', rotation: 0, x: 6 }, { type: 'Z', rotation: 1, x: 7 }, { type: 'Z', rotation: 0, x: 0 }, { type: 'S', rotation: 0, x: 6 }, { type: 'T', rotation: 2, x: 4 }, { type: 'L', rotation: 3, x: 2 }, { type: 'I', rotation: 0, x: 4 }, { type: 'J', rotation: 2, x: 7 }, { type: 'O', rotation: 0, x: 0 }])),
  endgame('tm-endgame-45', '斜廊', 41, 3438853325, setup(4101005, [{ type: 'J', rotation: 0, x: 7 }, { type: 'T', rotation: 0, x: 3 }, { type: 'S', rotation: 0, x: 2 }, { type: 'O', rotation: 0, x: 8 }, { type: 'L', rotation: 3, x: 5 }, { type: 'Z', rotation: 3, x: 0 }, { type: 'I', rotation: 2, x: 4 }, { type: 'O', rotation: 2, x: 0 }, { type: 'T', rotation: 2, x: 7 }, { type: 'I', rotation: 0, x: 6 }, { type: 'J', rotation: 1, x: 1 }, { type: 'Z', rotation: 3, x: 4 }, { type: 'S', rotation: 0, x: 2 }, { type: 'L', rotation: 2, x: 0 }])),
  endgame('tm-endgame-46', '边井', 42, 746220617, setup(4101001, [{ type: 'S', rotation: 0, x: 2 }, { type: 'J', rotation: 0, x: 7 }, { type: 'T', rotation: 1, x: 4 }, { type: 'O', rotation: 2, x: 0 }, { type: 'L', rotation: 2, x: 2 }, { type: 'Z', rotation: 1, x: 7 }, { type: 'I', rotation: 2, x: 5 }, { type: 'S', rotation: 2, x: 3 }, { type: 'L', rotation: 2, x: 1 }, { type: 'O', rotation: 0, x: 8 }])),
  endgame('tm-endgame-47', '悬廊', 43, 3709961825, setup(373965, [{ type: 'O', rotation: 0, x: 0 }, { type: 'L', rotation: 3, x: 1 }, { type: 'T', rotation: 1, x: -1 }, { type: 'J', rotation: 0, x: 7 }, { type: 'Z', rotation: 0, x: 7 }, { type: 'S', rotation: 1, x: 6 }, { type: 'I', rotation: 1, x: 7 }, { type: 'J', rotation: 3, x: 1 }, { type: 'O', rotation: 0, x: 0 }, { type: 'T', rotation: 2, x: 7 }])),
  endgame('tm-endgame-48', '断槽', 44, 2845894523, setup(4101024, [{ type: 'L', rotation: 0, x: 0 }, { type: 'J', rotation: 0, x: 6 }, { type: 'T', rotation: 2, x: 3 }, { type: 'I', rotation: 2, x: 2 }, { type: 'S', rotation: 1, x: 7 }, { type: 'O', rotation: 0, x: 0 }, { type: 'Z', rotation: 0, x: 5 }, { type: 'J', rotation: 2, x: 0 }, { type: 'O', rotation: 3, x: 3 }, { type: 'Z', rotation: 0, x: 7 }, { type: 'T', rotation: 2, x: 5 }])),
  endgame('tm-endgame-49', '叠井', 45, 1489293365, setup(4101019, [{ type: 'L', rotation: 0, x: 7 }, { type: 'S', rotation: 2, x: 5 }, { type: 'T', rotation: 2, x: 7 }, { type: 'Z', rotation: 0, x: 0 }, { type: 'J', rotation: 1, x: 3 }, { type: 'O', rotation: 3, x: 2 }, { type: 'I', rotation: 2, x: 6 }, { type: 'T', rotation: 2, x: 0 }, { type: 'I', rotation: 2, x: 0 }, { type: 'S', rotation: 0, x: 4 }, { type: 'J', rotation: 2, x: 7 }])),
  endgame('tm-endgame-50', '岔口', 46, 3487329389, setup(4101002, [{ type: 'S', rotation: 0, x: 6 }, { type: 'Z', rotation: 1, x: 4 }, { type: 'J', rotation: 2, x: 7 }, { type: 'I', rotation: 2, x: 0 }, { type: 'T', rotation: 0, x: 2 }, { type: 'L', rotation: 2, x: 0 }, { type: 'O', rotation: 3, x: 0 }, { type: 'T', rotation: 2, x: 4 }, { type: 'Z', rotation: 2, x: 7 }, { type: 'S', rotation: 3, x: 2 }, { type: 'O', rotation: 1, x: 5 }])),
]);
