...
const PUZZLE_LIBRARY: readonly PuzzleDefinition[] = Object.freeze([
  ...
  endgame('tm-puzzle-36', '斜阶', 36, 197830471, setup(142658, [{ type: 'T', rotation: 0, x: 1 }, { type: 'S', rotation: 1, x: 1 }, { type: 'Z', rotation: 1, x: -1 }, { type: 'I', rotation: 1, x: -2 }, { type: 'L', rotation: 1, x: 3 }, { type: 'J', rotation: 3, x: 6 }, { type: 'O', rotation: 0, x: 5 }, { type: 'T', rotation: 1, x: 0 }, { type: 'J', rotation: 0, x: 3 }])),
  ...
  endgame('tm-puzzle-38', '层塔', 38, 1431374977, setup(156544, [{ type: 'I', rotation: 0, x: 1 }, { type: 'J', rotation: 0, x: 1 }, { type: 'Z', rotation: 0, x: 4 }, { type: 'T', rotation: 0, x: 2 }, { type: 'O', rotation: 0, x: 7 }, { type: 'L', rotation: 2, x: 6 }, { type: 'S', rotation: 1, x: 3 }, { type: 'Z', rotation: 1, x: 1 }, { type: 'O', rotation: 0, x: 6 }, { type: 'T', rotation: 2, x: 4 }])),
  ...
  endgame('tm-puzzle-46', '边井', 46, 746220617, setup(4101001, [{ type: 'S', rotation: 0, x: 2 }, { type: 'J', rotation: 0, x: 7 }, { type: 'T', rotation: 1, x: 4 }, { type: 'O', rotation: 2, x: 0 }, { type: 'L', rotation: 2, x: 2 }, { type: 'Z', rotation: 1, x: 7 }, { type: 'I', rotation: 2, x: 5 }, { type: 'S', rotation: 2, x: 3 }, { type: 'L', rotation: 2, x: 1 }, { type: 'O', rotation: 0, x: 8 }])),
  endgame('tm-puzzle-47', '悬廊', 47, 3709961825, setup(373965, [{ type: 'O', rotation: 0, x: 0 }, { type: 'L', rotation: 3, x: 1 }, { type: 'T', rotation: 1, x: -1 }, { type: 'J', rotation: 0, x: 7 }, { type: 'Z', rotation: 0, x: 7 }, { type: 'S', rotation: 1, x: 6 }, { type: 'I', rotation: 1, x: 7 }, { type: 'J', rotation: 3, x: 1 }, { type: 'O', rotation: 0, x: 0 }, { type: 'T', rotation: 2, x: 7 }])),
  endgame('tm-puzzle-48', '断槽', 48, 2845894523, setup(4101024, [{ type: 'L', rotation: 0, x: 0 }, { type: 'J', rotation: 0, x: 6 }, { type: 'T', rotation: 2, x: 3 }, { type: 'I', rotation: 2, x: 2 }, { type: 'S', rotation: 1, x: 7 }, { type: 'O', rotation: 0, x: 0 }, { type: 'Z', rotation: 0, x: 5 }, { type: 'J', rotation: 2, x: 0 }, { type: 'O', rotation: 3, x: 3 }, { type: 'Z', rotation: 0, x: 7 }, { type: 'T', rotation: 2, x: 5 }])),
  endgame('tm-puzzle-49', '叠井', 49, 1489293365, setup(4101019, [{ type: 'L', rotation: 0, x: 7 }, { type: 'S', rotation: 2, x: 5 }, { type: 'T', rotation: 2, x: 7 }, { type: 'Z', rotation: 0, x: 0 }, { type: 'J', rotation: 1, x: 3 }, { type: 'O', rotation: 3, x: 2 }, { type: 'I', rotation: 2, x: 6 }, { type: 'T', rotation: 2, x: 0 }, { type: 'I', rotation: 2, x: 0 }, { type: 'S', rotation: 0, x: 4 }, { type: 'J', rotation: 2, x: 7 }])),
  endgame('tm-puzzle-50', '岔口', 50, 3487329389, setup(4101002, [{ type: 'S', rotation: 0, x: 6 }, { type: 'Z', rotation: 1, x: 4 }, { type: 'J', rotation: 2, x: 7 }, { type: 'I', rotation: 2, x: 0 }, { type: 'T', rotation: 0, x: 2 }, { type: 'L', rotation: 2, x: 0 }, { type: 'O', rotation: 3, x: 0 }, { type: 'T', rotation: 2, x: 4 }, { type: 'Z', rotation: 2, x: 7 }, { type: 'S', rotation: 3, x: 2 }, { type: 'O', rotation: 1, x: 5 }])),
]);
