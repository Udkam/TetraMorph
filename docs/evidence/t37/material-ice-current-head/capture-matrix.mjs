...
import { MATRIX_CASES, root } from './evidence-contract.mjs';
...
/** @type {any} */
const audit = { schema: 'tetramorph.t37.material-matrix.v1', generatedAt: new Date().toISOString(), origin, browser: await browser.version(), cases: {}, errors: [] };
